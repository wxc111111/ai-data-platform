...
INSERT INTO sys_permission (
    ...
    updated_time
      ...
      (1180, 0, 'Skill 管理', 'system:skill:menu', 'MENU', NULL, NULL, 'Cpu', 1180, 1, NOW(), NOW()),
      (1186, 1180, 'Skill 列表', 'system:skill:list-menu', 'MENU', '/home/skills', 'views/SkillView.vue', 'List', 1181, 1, NOW(), NOW()),
      (1181, 1186, 'Skill 列表查询', 'system:skill:list', 'API', NULL, NULL, NULL, 1182, 1, NOW(), NOW()),
      (1182, 1186, '新增 Skill', 'system:skill:add', 'API', NULL, NULL, NULL, 1183, 1, NOW(), NOW()),
      (1183, 1186, '更新 Skill', 'system:skill:update', 'API', NULL, NULL, NULL, 1184, 1, NOW(), NOW()),
      (1184, 1186, '删除 Skill', 'system:skill:delete', 'API', NULL, NULL, NULL, 1185, 1, NOW(), NOW()),
      (1185, 1186, 'Skill 测试', 'system:skill:test', 'API', NULL, NULL, NULL, 1186, 1, NOW(), NOW()),
